...
// ensuring we can test default branches of || operators
jest.mock('dotenv', () => ({
  config: jest.fn()
}));
...
describe('Configuration Module', () => {
  ...
  describe('Custom Values', () => {
    ...
    test('should accept all valid Winston log levels for LOG_LEVEL', () => {
  ...
  describe('Configuration Object Structure', () => {
    test('should export an object with host, port, env, and logLevel properties', () => {
